...
set tflite_model_file=D:\user-bak\Users\root\Desktop\person_detection_uint8_sdk\data\tf_model\person_detection.tflite
set gowin_programmer_path=D:\user-bak\Users\root\Desktop\person_detection_uint8_sdk\plugins\programmer
