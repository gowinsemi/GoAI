...
#include "tflite_gender_detection_parameters.h"
...
void loop(void)
{
	...
	uint32_t im_pix;
	int8_t image[3];	//0: unknown; 1: female; 2: male.
	...
	while(1)
	{
		...
		//led2 on : female
		//led3 on : male
		//led2 and led3 off : unknown
		command_responder(image);  
	}
}
