...
FUNCTION
    ...
    HDMI outputs camera image and character 'Zero' ~ 'Nine' on screen.
===============================================================================================================================================
RESULT
1. Input image data from camera.
2. Screen displays 'Zero' ~ 'Nine' through HDMI wire.
3. LED2,LED3,LED4,LED5,LED11 and LED12 display '0'~'9' through on and off.
===============================================================================================================================================
HOW TO RUN
1. Open "digit_detection_sdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --tflite_model_file        : specify the full path of digit_detection tflite model ("digit_detection_sdk\data\tf_model\digit_detection.tflite")
...
3. Double click "goai_run.bat" and run digit_detection SDK.
===============================================================================================================================================
OPERATING SYSTEM
1. Windows 7/10.
2. MacOS.
