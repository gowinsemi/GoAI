...
FUNCTION
    ...
    HDMI outputs camera image and character '00' ~ '59' on screen.
===============================================================================================================================================
RESULT
...
2. Change parameters in "goai_run.bat" and store;
    1) --tflite_model_file        : specify the full path of clock_detection tflite model ("clock_detection_sdk\data\tf_model\clock_detection.tflite")
