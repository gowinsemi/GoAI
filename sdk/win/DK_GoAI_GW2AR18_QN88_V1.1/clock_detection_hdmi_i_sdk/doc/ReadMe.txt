...
FUNCTION
    ...
    LED2,LED3,LED4,LED5,LED11 and LED12 are GoAI running indicator.
    HDMI outputs HDMI Rx image and character '00' ~ '59' on screen.
===============================================================================================================================================
RESULT
1. Input image data from HDMI Rx.
2. Screen displays '00' ~ '59' through HDMI.
3. LED2,LED3,LED4,LED5,LED11 and LED12 displays '00' ~ '59' through on and off.
===============================================================================================================================================
HOW TO RUN
1. Open "clock_detection_hdmi_i_sdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --tflite_model_file        : specify the full path of clock_detection tflite model ("clock_detection_hdmi_i_sdk\data\tf_model\clock_detection.tflite")
...
===============================================================================================================================================
CLOCK_DETCTION SOFTWARE DESIGN
1. Memory settings
    1) Flash
        start             size
        0x0               0x4000 (16KB)
