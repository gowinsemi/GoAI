...
FUNCTION
    ...
    HDMI outputs camera image and character 'Person' on screen.
===============================================================================================================================================
RESULT
...
2. Change parameters in "goai_run.bat" and store;
    1) --tflite_model_file        : specify the full path of person_detection tflite model ("person_detection_sdk\data\tf_model\person_detection.tflite")
