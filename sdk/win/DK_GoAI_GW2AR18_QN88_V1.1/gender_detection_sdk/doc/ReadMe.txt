===============================================================================================================================================
                                       Copyright (C) 2014-2021 Gowin Semiconductor Technology Co.,Ltd
                                                           All Rights Reserved
===============================================================================================================================================
                                                        GoAI:gender_detection SDK
===============================================================================================================================================
VERSION
    GoAI2.0
===============================================================================================================================================
FUNCTION
    Recognize female and male.
    LED2,LED3,LED4,LED5,LED11 are GoAI running indicator and LED12 is system running indicator.
    HDMI outputs camera image and character 'FEMALE' or 'MALE' on screen.
===============================================================================================================================================
RESULT
...
4. LED12 is blinking to indicate each loop.
===============================================================================================================================================
HOW TO RUN
1. Open "gender_detection_sdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --tflite_model_file        : specify the full path of gender_detection tflite model ("gender_detection_sdk\data\tf_model\gender_detection.tflite")
...
3. Double click "goai_run.bat" and run gender_detection SDK.
===============================================================================================================================================
OPERATING SYSTEM
1. Windows 7/10.
2. MacOS.
...
===============================================================================================================================================
SDK STRUCTURE
\gender_detection_sdk
    \bin                            --> Executable file
        \goai_run.bat               --> Run automatically
        \gender_detection.exe       --> Execute gender_detection SDK
...
===============================================================================================================================================
GENDER_DETCTION SOFTWARE DESIGN
1. Memory settings
    1) Flash
        start             size
        0x0               0x4000 (16KB)
...
===============================================================================================================================================
GENDER_DETECTION HARDWARE DESIGN
1. Cortex-M1 Core
