...
set programmer_path=C:\Users\liukai\Desktop\car_detection_sdk\plugins\programmer
set keil_path=D:\Keil_v5

echo.
echo GOAI CAR_DETECTION BEGINNING...

call car_detection.exe --device GW2AR18C --tflite_model_file %tflite_model_file% --programmer_path %programmer_path% --keil_path %keil_path% --training_type tf
