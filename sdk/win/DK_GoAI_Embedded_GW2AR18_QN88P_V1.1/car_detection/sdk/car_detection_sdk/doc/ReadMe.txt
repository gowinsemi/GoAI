...
2. If there are car, LED2,LED3,LED4,LED5,LED11 are on, and output 'Car' on screen through HDMI.
...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) programmer_path          : specify the full path of Gowin Programmer ("car_detection_sdk\plugins\programmer")
