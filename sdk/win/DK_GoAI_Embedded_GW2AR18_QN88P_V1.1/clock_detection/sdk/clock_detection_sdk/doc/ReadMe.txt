...
FUNCTION
    ...
    HDMI output camera image and character '00' ~ '59' on screen.
===============================================================================================================================================
RESULT
...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) programmer_path          : specify the full path of Gowin Programmer ("clock_detection_sdk\plugins\programmer")
