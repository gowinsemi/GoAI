...
FUNCTION
    ...
    HDMI output hdmi rx image and character '00' ~ '59' on screen.
===============================================================================================================================================
RESULT
1. Input image data from hdmi rx device.
2. Screen displays '00' ~ '59' through HDMI wire.
...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) programmer_path          : specify the full path of Gowin Programmer ("clock_detection_hdmi_i_sdk\plugins\programmer")
