...
FUNCTION
    ...
    HDMI output camera image and character 'Car' on screen.
===============================================================================================================================================
RESULT
1. Input image data from hdmi rx device.
2. If there are car, LED2,LED3,LED4,LED5,LED11 are on, and output 'Car' on screen through HDMI tx.
   If there are no car, LED2,LED3,LED4,LED5,LED11 are off. 
...
2. Change parameters in "goai_run.bat" and store;
    1) tflite_model_file        : specify the full path of car_detection tflite model ("car_detection_hdmi_i_sdk\data\tf_model\car_detection.tflite")
    2) programmer_path          : specify the full path of Gowin Programmer ("car_detection_hdmi_i_sdk\plugins\programmer")
...
\car_detection_hdmi_i_sdk
    \bin                            --> Executable file
        ...
        \car_detection.exe          --> Execute car_detection_hdmi_i SDK
