...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) --tflite_model_file : specify the full path of digit_detection tflite model ("digit_detection_sdk\data\tf_model\digit_detection.tflite")
...
===============================================================================================================================================
DIGIT_DETECTION SOFTWARE DESIGN
1. Memory settings
    1) IROM1
        start             size
        0x0               0x4000 (16KB)
