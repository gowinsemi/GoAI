...
typedef struct{
    ...
    int32_t conv_output_multiplier_offset;	//output_multiplier address offset in spi-flash
    int32_t conv_output_shift_offset;				//output_shift address offset in spi-flash
...
extern int32_t AhbPhotoController(AhbTFLiteConvolution_t* core,int32_t cmd);
extern void AhbPhotoWriteXY(AhbTFLiteConvolution_t* core,int32_t xs,int32_t xe,int32_t ys,int32_t ye);
extern int32_t AhbPhotoReady(AhbTFLiteConvolution_t* core);  
extern int32_t AhbPhotoReady1(AhbTFLiteConvolution_t* core); 
