...
===============================================================================================================================================
RESULT
1. Input image data from hdmi input interface.
2. Leds display digit 0~9.
   1) LED2 : 0
   2) LED4 : 1
   3) LED3 : 2
   4) LED6 : 3
...
3. Display word "Zero" ~ "Nine" on screen when there is a digit 0~9.
4. Serial terminal outputs digit "Zero" ~ "Nine".
===============================================================================================================================================
HOW TO RUN
1. Open "digit_detection_hdmi_isdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --device            : specify the device type (default is GW2A55C)
    2) --tflite_model_file : specify the full path of digit_detection tflite model ("digit_detection_hdmi_i_sdk\data\tf_model\digit_detection.tflite")
...
1. DK-GoAI-Embedded-GW2A55-PG484
    GW2A-55C
    GW2A-LV55PG484C8/I7
2. 2x screens with HDMI Interface
3. 2x HDMI wires
4. USB wire
===============================================================================================================================================
...
\digit_detection_hdmi_i_sdk
    \bin                            --> Executable file
        ...
        \digit_detection.exe        --> Execute digit_detection SDK
...
===============================================================================================================================================
DIGIT_DETECTION_HDMI_I SOFTWARE DESIGN
1. Memory settings
    1) IROM1
        start             size
        0x0               0x4000 (16KB)
...
===============================================================================================================================================
DIGIT_DETECTION_HDMI_I HARDWARE DESIGN
1. Cortex-M1 Core
    1) Disable debug
