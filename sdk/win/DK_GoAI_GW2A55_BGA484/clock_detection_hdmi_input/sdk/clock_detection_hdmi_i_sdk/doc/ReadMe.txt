...
===============================================================================================================================================
RESULT
1. Input image data from hdmi input.
...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) --tflite_model_file : specify the full path of clock_detection tflite model ("clock_detection_hdmi_i_sdk\data\tf_model\clock_detection.tflite")
