===============================================================================================================================================
                                       Copyright (C) 2014-2021 Gowin Semiconductor Technology Co.,Ltd
                                                           All Rights Reserved
===============================================================================================================================================
                                                      GoAI:analog_meter_detection SDK
===============================================================================================================================================
VERSION
    GoAI2.0
===============================================================================================================================================
FUNCTION
    Recognize analog meter grid.
===============================================================================================================================================
RESULT
1. Input image data from camera.
2. LED2~7 display GoAI running status.
3. Display grid word "00" ~ "59" on screen when there is an analog meter in each grid.
4. Serial terminal outputs analog meter digit.
===============================================================================================================================================
HOW TO RUN
1. Open "analog_meter_detection_sdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --device                   : specify the device type (default is GW2A55C)
    2) --tflite_model_file        : specify the full path of analog_meter_detection tflite model ("analog_meter_detection_sdk\data\tf_model\clock_detection.tflite")
...
3. Double click "goai_run.bat" and run analog_meter_detection SDK.
===============================================================================================================================================
OPERATING SYSTEM
1. Windows 7/10.
2. MacOS.
...
1. 1x DK-GoAI-GW2A55-PG484 V1.0 board
    GW2A-55C (version C)
    GW2A-LV55PG484C8/I7
2. 1x Screen with HDMI Interface
3. 1x HDMI wire
4. 1x USB wire
5. 1x USB-to-UART wire
6. 1x Camera (Recommend HDF3M-811V.10)
===============================================================================================================================================
SDK STRUCTURE
\analog_meter_detection_sdk
    \bin                            --> Executable file
        \goai_run.bat               --> Run automatically
        \clock_detection.exe        --> Execute analog_meter_detection SDK
...
===============================================================================================================================================
ANALOG_METER_DETECTION SOFTWARE DESIGN
1. Memory settings
    1) Flash
        start             size
        0x0               0x4000 (16KB)
...
===============================================================================================================================================
ANALOG_METER_DETECTION HARDWARE DESIGN
1. Cortex-M1 Core
    1) Disable Debug
