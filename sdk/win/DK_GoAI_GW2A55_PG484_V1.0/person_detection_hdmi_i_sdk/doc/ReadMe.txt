...
===============================================================================================================================================
RESULT
1. Input image data from remote terminal through HDMI input device.
...
2. Change parameters in "goai_run.bat" and store;
    ...
    2) --tflite_model_file        : specify the full path of person_detection tflite model ("person_detection_hdmi_i_sdk\data\tf_model\person_detection.tflite")
