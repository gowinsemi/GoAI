...
// Sets up any resources needed for the feature generation pipeline.tflite::ErrorReporter* error_reporter
TfLiteStatus InitializeMicroFeatures(void);

// Converts audio sample data into a more compact form that's appropriate for
// feeding into a neural network.tflite::ErrorReporter* error_reporter,
