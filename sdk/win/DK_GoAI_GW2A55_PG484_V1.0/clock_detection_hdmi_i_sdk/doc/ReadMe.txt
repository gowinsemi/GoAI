===============================================================================================================================================
                                       Copyright (C) 2014-2021 Gowin Semiconductor Technology Co.,Ltd
                                                           All Rights Reserved
===============================================================================================================================================
                                                    GoAI:clock_detection_hdmi_i SDK
===============================================================================================================================================
VERSION
    GoAI2.0
===============================================================================================================================================
...
3. Display word "00" ~ "59" on screen through hdmi output when there is a clock.
4. Serial terminal outputs clock digit.
===============================================================================================================================================
HOW TO RUN
1. Open "clock_detection_hdmi_i_sdk\bin\goai_run.bat";
2. Change parameters in "goai_run.bat" and store;
    1) --device                   : specify the device type (default is GW2A55C)
    2) --tflite_model_file        : specify the full path of clock_detection_hdmi_i tflite model ("clock_detection_hdmi_i_sdk\data\tf_model\clock_detection.tflite")
...
3. Double click "goai_run.bat" and run clock_detection_hdmi_i SDK.
===============================================================================================================================================
OPERATING SYSTEM
1. Windows 7/10.
2. MacOS.
...
===============================================================================================================================================
SDK STRUCTURE
\clock_detection_hdmi_i_sdk
    \bin                            --> Executable file
        \goai_run.bat               --> Run automatically
        \clock_detection.exe        --> Execute clock_detection_hdmi_i SDK
...
===============================================================================================================================================
CLOCK_DETECTION_HDMI_I SOFTWARE DESIGN
1. Memory settings
    1) Flash
        start             size
        0x0               0x4000 (16KB)
...
===============================================================================================================================================
CLOCK_DETECTION_HDMI_I HARDWARE DESIGN
1. Cortex-M1 Core
    1) Disable Debug
